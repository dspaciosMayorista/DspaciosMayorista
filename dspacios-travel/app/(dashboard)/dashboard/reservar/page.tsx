...
export default async function ReservarPage() {
  ...
  for (let from = 0; ; from += PAGE) {
    const { data: page } = await sb
      ...
      .select(
        "modulo, bloqueo_label, bloqueo_id, salida_id, paquete_id, hotel_id, servicio_nombre, tipo_tarifa, pax_desde, pax_hasta, fecha_ida, fecha_regreso, noches, destino_nombre, paquete_nombre, hotel_nombre, categoria, regimen, acomodacion, precio_pvp, moneda"
      )
