...
// UI de la página "Cotizar". El número de WhatsApp viene del CMS (web_config).
export default function CotizarClient({ waNumero }) {
  const numero = waNumero || '573212150582';
  const benefits = [
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          >
            ...
            <div className="bg-white rounded-3xl p-6 shadow-lg border border-gray-100">
              ...
              <a href={`https://wa.me/${numero}`} target="_blank" rel="noreferrer" className="block w-full text-center py-3 bg-green-50 text-green-600 rounded-xl font-bold hover:bg-green-100 transition-colors">
                WhatsApp Directo
              </a>
            </div>
          </motion.div>
