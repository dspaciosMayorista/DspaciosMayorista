...
// Los datos de la empresa (razón social, NIT, RNT, cuenta bancaria, correo,
// ciudad) YA NO viven aquí: vienen de `empresa_config` (ver lib/empresa.ts) y se
// inyectan al renderizar el contrato. En el texto legal abajo se usan TOKENS:
//   {{EMPRESA}} = nombre legal · {{CUENTA}} = cuenta bancaria ·
//   {{CORREO}} = correo · {{CIUDAD}} = ciudad/jurisdicción.
...
export const CONTRATO_INTRO =
  ...
  "{{EMPRESA}}, sociedad legalmente constituida y registrada en Colombia, se celebra " +
...
export const CLAUSULAS: ClausulaContrato[] = [
  {
    ...
    parrafos: [
      "El presente contrato tiene por objeto regular la prestación de servicios turísticos por parte de {{EMPRESA}} al CLIENTE, que incluyen, según el caso, reservas aéreas, hoteleras, terrestres, navieras, excursiones y demás servicios complementarios contratados. Los servicios serán prestados por proveedores debidamente habilitados, y {{EMPRESA}} actuará como intermediario entre el CLIENTE y dichos proveedores.",
    ],
  },
  {
    numero: 2,
    titulo: "Obligaciones de {{EMPRESA}}",
    parrafos: [
      ...
      "c) Reembolsar los valores recibidos al CLIENTE únicamente cuando {{EMPRESA}} cancele el viaje por fuerza mayor o caso fortuito, o bien ofrecer un servicio equivalente.",
  ...
  },
  {
    ...
    parrafos: [
      "a) No responsabilizar a {{EMPRESA}} por gastos, servicios o consumos no incluidos en este contrato.",
  ...
  },
  {
    ...
    parrafos: [
      "a) El CLIENTE pagará el valor total del plan en la cuenta {{CUENTA}} a nombre de {{EMPRESA}}",
      ...
      "d) El CLIENTE reconoce que los pagos efectuados por fuera de las cuentas oficiales de la agencia no serán válidos ni reconocidos por {{EMPRESA}}.",
    ],
  },
  {
    numero: 5,
  ...
  },
  {
    ...
    parrafos: [
      ...
      "b) {{EMPRESA}} podrá dar por terminado el contrato con justa causa si el CLIENTE incumple los plazos de pago.",
      "c) En caso de enfermedad o calamidad comprobable, el CLIENTE podrá solicitar a los proveedores la devolución según sus políticas. {{EMPRESA}} no será responsable por reintegros ni compensaciones de dichos servicios.",
  ...
  },
  {
    ...
    parrafos: [
      "a) {{EMPRESA}} actúa como intermediario, por lo cual no es responsable por retrasos, cambios de itinerario, cancelaciones o incumplimientos de aerolíneas, navieras, hoteles, operadores o transportistas.",
      "b) Los horarios de vuelos y servicios son responsabilidad exclusiva de los proveedores.",
      "c) {{EMPRESA}} queda exonerado de responsabilidad por causas de fuerza mayor o caso fortuito, tales como fenómenos naturales, conflictos, pandemias, decisiones gubernamentales o situaciones de orden público.",
      ...
      "e) El CLIENTE debe adquirir un seguro o asistencia médica de viaje; si decide no hacerlo, exime expresamente a {{EMPRESA}} de toda responsabilidad derivada de eventos médicos o emergencias.",
    ],
  },
  {
    numero: 9,
    ...
    parrafos: [
      "El CLIENTE declara bajo la gravedad de juramento que los fondos utilizados para la compra de los servicios turísticos provienen de actividades lícitas y que no están relacionados con lavado de activos, financiación del terrorismo o actividades ilícitas. {{EMPRESA}} podrá dar por terminado el contrato sin indemnización si identifica indicios de actividades irregulares o incumplimiento de esta obligación.",
    ],
  },
  {
    numero: 10,
    ...
    parrafos: [
      "El CLIENTE es el único responsable de contar con la documentación y requisitos migratorios o sanitarios exigidos (pasaporte, visas, vacunas, permisos de salida de menores, etc.). {{EMPRESA}} no asume responsabilidad si el CLIENTE o alguno de sus acompañantes no puede viajar por carecer de dichos documentos o incumplir las exigencias de las autoridades.",
    ],
  },
  {
    numero: 11,
    ...
    parrafos: [
      "El término de garantía de los servicios turísticos será de quince (15) días calendario posteriores a la finalización del viaje, tiempo durante el cual el CLIENTE podrá presentar reclamaciones directas ante {{EMPRESA}}.",
    ],
  },
  {
    numero: 12,
  ...
  },
  {
    ...
    parrafos: [
      "El CLIENTE declara que la información y datos personales suministrados son verídicos, completos y actualizados. Cualquier error u omisión que afecte la prestación del servicio exime a {{EMPRESA}} de responsabilidad y de los costos derivados de su corrección.",
    ],
  },
  {
    numero: 14,
    ...
    parrafos: [
      "El presente contrato se perfecciona desde el primer pago realizado por el CLIENTE y la confirmación de la reserva por parte de {{EMPRESA}}. Los servicios se ejecutarán únicamente cuando el valor total del plan haya sido cancelado dentro de los plazos establecidos.",
    ],
  },
  {
    numero: 15,
    ...
    parrafos: [
      "En cumplimiento de la Ley 1581 de 2012 y sus decretos reglamentarios, {{EMPRESA}} informa al CLIENTE que los datos personales suministrados serán tratados conforme a su Política de Protección de Datos, con el fin de gestionar reservas, pagos, comunicaciones y ofertas comerciales. El CLIENTE podrá ejercer sus derechos de acceso, corrección, supresión o revocatoria enviando su solicitud al correo {{CORREO}}.",
    ],
  },
  {
    numero: 16,
    ...
    parrafos: [
      "El presente contrato se regirá por las leyes de la República de Colombia. Cualquier controversia se resolverá en la jurisdicción ordinaria de {{CIUDAD}}.",
    ],
  },
  {
    numero: 17,
    ...
    parrafos: [
      "El CLIENTE acepta que la realización de cualquier pago (abono o pago total) a las cuentas oficiales de {{EMPRESA}} implica su aceptación expresa, inequívoca y definitiva de todos los términos y condiciones contenidos en este contrato. El CLIENTE autoriza a {{EMPRESA}} a considerar el comprobante, recibo o registro de la transacción como prueba de la celebración y aceptación del contrato, así como del contenido de las obligaciones pactadas.",
    ],
  },
  {
    numero: 18,
 ...
 *      → "En constancia, se emite digitalmente en {ciudad}, el 1 de junio de 2026."
 */
export const CONSTANCIA_PREFIJO =
  "En constancia, se emite digitalmente en {{CIUDAD}}, el";
 ...
 *      → "{Nombre de la empresa} · Todos los derechos reservados © 2025"
 */
