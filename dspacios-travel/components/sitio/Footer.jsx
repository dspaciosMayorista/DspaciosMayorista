        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/paquetes" className="text-white/80 hover:text-[#d8f511] transition-colors">
                  Paquetes
                </Link>
              </li>
              <li>
                <Link href="/destinos" className="text-white/80 hover:text-[#d8f511] transition-colors">
                  Destinos
                </Link>
              </li>
              <li>
                <Link href="/nosotros" className="text-white/80 hover:text-[#d8f511] transition-colors">
                  Nosotros
                </Link>
              </li>
              <li>
                <Link href="/testimonios" className="text-white/80 hover:text-[#d8f511] transition-colors">
                  Testimonios
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-white/80 hover:text-[#d8f511] transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/tarifario" className="text-white/80 hover:text-[#d8f511] transition-colors">
                  Tarifario
                </Link>
              </li>
            </ul>
