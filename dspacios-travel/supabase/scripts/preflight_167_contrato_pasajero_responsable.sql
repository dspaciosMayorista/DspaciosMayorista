...
from (values ('ajustar_sillas_por_pasajeros'), ('guardar_pasajeros_contrato'), ('crear_pasajeros_contrato'), ('crear_pasajeros_contrato_multi'), ('edad_anios'), ('es_infante_por_edad'), ('_ajustar_sillas_nucleo'), ('_ajustar_sillas_bloqueo_nucleo'), ('_guardar_pasajeros_nucleo'), ('_reemplazar_pasajeros_nucleo'), ('_autorizado_escribir_pasajeros'),
       -- B22/B23: resolución compartida de la fecha de referencia y reloj
       -- de la base que lee la app (`_fecha_referencia_guc` se eliminó en B23).
       ('_fecha_referencia_efectiva'), ('fecha_referencia_servidor')) as f(nombre);
