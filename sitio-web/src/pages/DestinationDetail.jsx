...
const DestinationDetail = () => {
  ...
  const relatedPackages = packages.filter(p => p.destination.includes(destination?.name));
  ...
  return (
    <div className="pt-20 bg-white pb-24">
      <Helmet>
        <title>{destination.name} | D'Spacios Travel</title>
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-12 -mt-20 relative z-10">
        <Link to="/destinos" className="inline-flex items-center text-white hover:text-[#d8f511] mb-8 font-medium">
            ...
            <div className="sticky top-24 space-y-8">
              <div className="bg-[#120573] rounded-3xl p-8 text-white text-center relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <Button className="w-full bg-[#d8f511] text-[#120573] hover:bg-white font-bold">
                    Contactar Asesor
                  </Button>
                </div>
