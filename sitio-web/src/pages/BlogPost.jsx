...
const BlogPost = () => {
  ...
  return (
    <div className="pt-28 pb-24 bg-white min-h-screen">
      <Helmet>
        <title>{post.title} | Blog D'Spacios Travel</title>
      </Helmet>

      <article className="container mx-auto px-4 max-w-4xl">
        <Link to="/blog" className="inline-flex items-center text-gray-500 hover:text-[#120573] mb-8 font-medium transition-colors">
