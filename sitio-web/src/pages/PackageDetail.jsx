...
const PackageDetail = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-24">
      <Helmet>
        <title>{pkg.title} | D'Spacios Travel</title>
      </Helmet>
      ...
      <div className="relative h-[60vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-end pb-20">
          <div className="container mx-auto px-4">
            <Link to="/paquetes" className="inline-flex items-center text-white/80 hover:text-[#d8f511] mb-6 transition-colors">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl sticky top-24 border border-gray-100">
              ...
              <div className="space-y-4 mb-8">
                <Button 
                  ...
                  onClick={() => window.open(`https://wa.me/1234567890?text=Hola, estoy interesado en el paquete ${pkg.title}`, '_blank')}
                >
                  <MessageCircle className="mr-2 h-6 w-6" /> Cotizar en WhatsApp
                </Button>
                <Button 
                  className="w-full bg-[#120573] hover:bg-[#0d0459] text-white font-bold h-14 text-lg rounded-xl shadow-lg transition-all"
